    ...
    <div class="collapse navbar-collapse" id="menu">
        ...
        <?php if ($data['menu']): ?>
            <div class="d-flex justify-content-start">
                <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                    <li class="nav-item">
                        <a href="<?= ROOT ?>courses"
                           class="nav-link <?= (isset($data['active']) && $data['active'] == 'courses') ? 'active' : '' ?>">Cursos</a>
                    </li>
                    <li class="nav-item">
                        <a href="<?= ROOT ?>books"
                           class="nav-link <?= (isset($data['active']) && $data['active'] == 'books') ? 'active' : '' ?>">Libros</a>
                    </li>
                    <li class="nav-item">
                        <a href="<?= ROOT ?>shop/whoami"
                           class="nav-link <?= (isset($data['active']) && $data['active'] == 'whoami') ? 'active' : '' ?>">Quienes
                            somos</a>
                    </li>
                    <li class="nav-item">
                        <a href="<?= ROOT ?>shop/contact"
                           class="nav-link <?= (isset($data['active']) && $data['active'] == 'contact') ? 'active' : '' ?>">Contacto</a>
                    </li>
                </ul>
            </div>
        ...
        <?php if (isset($data['admin']) && $data['admin']): ?>
            <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                ...
                <li class="nav-item">
                    <a href="<?= ROOT ?>adminShop/logout" class="nav-link">cerrar sesion</a>
                </li>
            </ul>
        <?php endif; ?>
    </div>
